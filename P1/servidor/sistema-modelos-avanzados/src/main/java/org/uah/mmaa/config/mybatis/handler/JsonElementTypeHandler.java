...
import org.uah.mmaa.config.mybatis.JsonElementLazyWrapper;
...
/**
 * Map PostgreSQL JSON type to Gson JsonElement does not return null (empty node instead). Just use JSON string representation as intermediate data
 * format.
 *
 * @see JsonElement
 */
